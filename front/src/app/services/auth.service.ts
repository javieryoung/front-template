...
export class AuthService {
  ...
  constructor(
    ...
    let ls = this.localStorage.getItem('user');
    if (ls)
      this.user = new User(ls);
  ...
  logout() {
    ...
    this.permissionService.deleteAccesses();
  ...
  getAccesses() {
    return this.http.get(this.url + '/get_accesses', {}).toPromise();
